...
$sql = "SELECT id, name, category, price, sale_price, image_data FROM earringsproduct";
...
<script>
    ...
    <form method="POST" action="cart_icon_click.php"> <!-- Submit to cart_icon_click.php -->
