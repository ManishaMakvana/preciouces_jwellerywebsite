...
<head>
    ...
    <link rel="stylesheet" href="gold_radiance.css">
    <script src="gold_radiance.js"></script>
...
$sql = "SELECT id, name, category, price, sale_price, image_data FROM gold_radianceproduct";
...
<div id="product-list" class="product-grid">
    <!-- PHP will generate the product items here -->
    <div class="productName" >
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '</form>';
                echo '<a href="wishlist.php?product_id=' . htmlspecialchars($row['id']) . '" class="add-to-wishlist">';
