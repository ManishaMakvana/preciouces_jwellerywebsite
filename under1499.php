...
<head>
    ...
    <link rel="stylesheet" href="under1499.css">
    <script src="under1499.js"></script>
...
$sql = "SELECT id, name, category, price, sale_price, image_data FROM under1499product";
